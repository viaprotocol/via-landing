...
function Footer() {
  return (
    <div className="mt-9 px-6 py-10 pb-[51px] lg:pb-[64px] text-white/25 lg:mt-[195px] lg:px-[60px]">
      <div className="flex flex-col-reverse items-center lg:flex-row lg:justify-between">
        ...
        <ul className="mb-[80px] flex gap-4 lg:mb-0 lg:gap-10">
          {socials.map(social => (
            <li key={social.name}>
              <a href={social.link} className="flex h-10 w-10 items-center justify-center" target="_blank" rel="noopener noreferrer">
                {social.icon}
              </a>
            </li>
          ))}
